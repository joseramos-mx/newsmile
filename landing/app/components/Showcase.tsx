    ...
    >
      ...
      <div
        ...
        style={{
          position: "absolute",
          inset: 0,
          backgroundImage: `url('${service.image}'), ${service.fallback}`,
